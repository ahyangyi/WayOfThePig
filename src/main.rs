...
fn main() {
    ...
    for _i in 0..1000000 {
        ...
        let mut p1 : big_money::BigMoneyController<kingdom::SimpleKingdom> = big_money::BigMoneyController::make();
        let mut p2 : big_money::BigMoneyController<kingdom::SimpleKingdom> = big_money::BigMoneyController::make();
