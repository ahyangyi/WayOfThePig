...
fn total_money<G: game_state::GameState, const P: usize>(game: &mut G) -> u32 {
...
fn num_money<G: game_state::GameState, const P: usize>(game: &mut G) -> u32 {
...
impl controller::Controller for Controller {
    fn act<G: game_state::GameState, const P: usize>(&mut self, game: &mut G) {
        game.play_necropolis::<P>();
        game.play_smithy::<P>();
        game.play_smithy::<P>();
    }
    fn buy<G: game_state::GameState, const P: usize>(&mut self, game: &mut G) {
